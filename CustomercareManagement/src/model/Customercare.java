...
public class Customercare {
	//A common method to connect to the DB
		...
		public String insertcustomerdetails(String password, String name, String customerPhone, String email)
		 ...
		 String query = " insert into customer_care (`id`,`cusid`,`description`,`email`,`cusname`)" + " values (?, ?, ?, ?, ?)";
		...
		public String readItems()
		 ...
		 String customerPassword = rs.getString("cusid");
		 String customerName = rs.getString("description");
		 String customerPhone =rs.getString("email");
		 String customerEmail = rs.getString("cusname");
		 ...
		 output += "<td><input name='btnUpdate' type='button' value='Update' class='btn btn-secondary'></td>"
				 + "<td><form method='post' action='customercare.jsp'>"
		...
		public String updatecustomerdetails(String ID, String password, String name, String phone, String email)
		 ...
		 // create a prepared statement
		 String query = "UPDATE customer_care SET name=?,permanent_address=?,nic=?,email=? WHERE id=?";
		 PreparedStatement preparedStmt = con.prepareStatement(query);
		 // binding values
