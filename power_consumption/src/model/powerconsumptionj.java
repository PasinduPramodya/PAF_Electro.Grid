...
public class powerconsumptionj {
	//A common method to connect to the DB
		...
		public String insertcustomerdetails(String password, String name, String customerPhone, String email)
		 ...
		 String query = " insert into power_consumption (`id`,`unit`,`date_from`,`date_to`,`cusid`)" + " values (?, ?, ?, ?, ?)";
		...
		public String readItems()
		 ...
		 String customerName = rs.getString("date_from");
		 String customerPhone =rs.getString("date_to");
		...
		public String updatecustomerdetails(String ID, String password, String name, String phone, String email)
		 ...
		 // create a prepared statement
		 String query = "UPDATE power_consumption SET unit=?,date_from=?,date_to=?,cusid=? WHERE id=?";
		 PreparedStatement preparedStmt = con.prepareStatement(query);
		 // binding values
		...
		public String deleteItem(String customerID)
		 ...
		 // create a prepared statement
		 String query = "delete from power_consumption where id=?";
		 PreparedStatement preparedStmt = con.prepareStatement(query);
		 // binding values
